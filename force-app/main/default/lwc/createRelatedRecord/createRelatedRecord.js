...
export default class createRelatedRecord extends LightningElement {
   ...
   // save called on click of save to insert account and contact record with LDS
    save() {
        ...
        console.log('Hello======= '+this.accountName +'        '+NAME_FIELD.fieldApiName);
        const accRecordInput = { apiName: ACCOUNT_OBJECT.objectApiName, fields};
        console.log('2nd======= '+ ACCOUNT_OBJECT.objectApiName +'  '+fields);
            ...
            .then(account => {
               ...
               // display success toast msg for account
                this.dispatchEvent(
                    new ShowToastEvent({
                        title: 'Success',
                        message: this.accountName + 'Account created',
                        variant: 'success',
                    }),
                );
                  ...
                  createRecord(recordInput_Contact)
                    .then(contact => {
                        ...
                        this.dispatchEvent(
                            new ShowToastEvent({
                                title: 'Success',
                                message: this.accountName + 'Contact created',
                                variant: 'success',
                            }),
                        );
